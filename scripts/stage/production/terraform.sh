...
export TF_VAR_PUBLIC_SUBNETS_CIDR="$TF_VAR_PUBLIC_SUBNETS_CIDR."
export TF_VAR_PRIVATE_SUBNETS_CIDR="$TF_VAR_PRIVATE_SUBNETS_CIDR"
...
export TF_VAR_ENABLE_VPN_GATEWAY="$TF_VAR_ENABLE_VPN_GATEWAY"
